<template>
  <div class="vux-x-input weui-cell" :class="{'weui-cell_warn': showWarn}">
    ...
    <div class="weui-cell__ft">
      ...
      <icon class="vux-input-icon" type="warn"
...
<script>
  ...
  import {Icon, InlineDesc} from 'vux'
  ...
  export default {
    ...
    computed: {
      ...
      showWarn () {
        console.log(!this.novalidate && !this.equalWith && !this.valid && this.firstError && (this.touched || this.forceShowError))
    ...
    watch: {
      ...
      currentValue (newVal) {
        ...
        this.$emit('on-valid', { // 返回验证信息
          valid: this.valid,
          validText: this.firstError
        })
      }
    }
  }
